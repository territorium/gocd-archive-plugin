 ...
 */
@Extension
public class ArchivePlugin implements GoPlugin {

  private static final Logger LOGGER = Logger.getLoggerFor(ArchivePlugin.class);
  ...
  public GoPluginApiResponse handle(GoPluginApiRequest request) throws UnhandledRequestTypeException {
    try {
      ...
      ArchivePlugin.LOGGER.error("Error while executing request " + request.requestName(), e);
