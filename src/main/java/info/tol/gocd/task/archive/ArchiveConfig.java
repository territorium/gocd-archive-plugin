...
public interface ArchiveConfig {
  ...
  public static ConfigResponse create() {
    ...
    config.setValue(ArchiveConfig.TARGET, null, "Archive Name", "1", true, false);
    config.setValue(ArchiveConfig.SOURCE, null, "Archive Files", "2", true, false);
    return config;
  }
